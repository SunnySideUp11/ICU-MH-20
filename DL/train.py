...
# from models import create_model, weight_init, timesformer
...
def main(index):
    ...
    model = resnet3d101(pretrained=True, freeze=True)
    
    # model = create_resnet(input_channel=3, 
    #                       model_depth=101,
    #                       model_num_class=7,
    #                       norm=nn.BatchNorm3d,
    #                       activation=nn.ReLU)
    ...
    # lr_scheduler = torch.optim.lr_scheduler.MultiStepLR(optimizer, milestones=[5, 25])
